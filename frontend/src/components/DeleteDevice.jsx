...
const DeleteDevice = ({ device, onCancel, onDelete, message }) => {
  ...
  const handleDelete = () => {
    ...
    const msg = `Czy na pewno chcesz zarchiwizować wszystkie egzemplarze tego sprzętu?\nLiczba egzemplarzy do archiwizacji: ${count}\nTej operacji nie można cofnąć.`;
  ...
  return (
    <div className="p-6 bg-white rounded shadow max-w-lg w-full">
      <h2 className="text-xl font-bold mb-4 text-red-700">Archiwizuj sprzęt</h2>
      ...
      <div className="space-y-3 mb-4">
        ...
        <div className="mt-2 text-red-700 font-semibold">
          Ilość urządzeń do archiwizacji: {device.instances?.length ?? 0}
        </div>
      </div>
